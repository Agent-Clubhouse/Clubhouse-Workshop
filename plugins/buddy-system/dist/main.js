...
// src/state/groups.ts
var INDEX_KEY = "buddyGroupIndex";
function groupKey(id) {
  return `buddyGroup_${id}`;
}
function uuid() {
...
function useTheme(themeApi) {
  ...
  const style = React2.useMemo(() => mapThemeToCSS(theme), [theme]);
...
function MemberCard({ api, member, onRemove, onSetLeader }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsx(AgentAvatar, { agentId: member.agentId, size: "sm", showStatusRing: true }),
    /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
        member.isLeader && /* @__PURE__ */ jsx("span", { title: "Group leader", style: { fontSize: 12 }, children: "\u2605" }),
        /* @__PURE__ */ jsx("span", { style: { fontSize: 13, fontWeight: 600, color: "var(--text-primary)", fontFamily: "var(--font-family)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: member.agentName })
      ] }),
...
function AddMemberDialog({ api, existingAgentIds, onAdd, onCancel }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { padding: 16, border: "1px solid var(--border-accent)", borderRadius: 8, background: "var(--bg-secondary)", marginBottom: 8 }, children: [
    /* @__PURE__ */ jsx("div", { style: { fontSize: 13, fontWeight: 600, color: "var(--text-primary)", marginBottom: 12, fontFamily: "var(--font-family)" }, children: "Add Member" }),
    agents.length === 0 ? /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: "var(--text-tertiary)", fontFamily: "var(--font-family)", marginBottom: 12 }, children: "No eligible durable agents found. Start a durable agent in a project first." }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("label", { style: { display: "block", fontSize: 11, color: "var(--text-secondary)", marginBottom: 4, fontFamily: "var(--font-family)" }, children: "Agent" }),
      /* @__PURE__ */ jsx("select", { value: selectedAgentId, onChange: (e) => setSelectedAgentId(e.target.value), style: { width: "100%", padding: "6px 8px", fontSize: 13, borderRadius: 4, border: "1px solid var(--border-primary)", background: "var(--bg-primary)", color: "var(--text-primary)", fontFamily: "var(--font-family)", marginBottom: 10 }, children: agents.map((a) => {
        const proj = projects.find((p) => p.id === a.projectId);
        return /* @__PURE__ */ jsxs("option", { value: a.id, children: [
          a.name,
          " (",
      ...
      /* @__PURE__ */ jsx("label", { style: { display: "block", fontSize: 11, color: "var(--text-secondary)", marginBottom: 4, fontFamily: "var(--font-family)" }, children: "Context" }),
      /* @__PURE__ */ jsx("textarea", { value: context, onChange: (e) => setContext(e.target.value), placeholder: "e.g. Backend API agent", rows: 2, style: { width: "100%", padding: "6px 8px", fontSize: 12, borderRadius: 4, border: "1px solid var(--border-primary)", background: "var(--bg-primary)", color: "var(--text-primary)", fontFamily: "var(--font-family)", resize: "vertical", marginBottom: 12, boxSizing: "border-box" } })
    ] }),
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end" }, children: [
      /* @__PURE__ */ jsx("button", { onClick: onCancel, style: { padding: "6px 14px", fontSize: 12, borderRadius: 4, border: "1px solid var(--border-primary)", background: "var(--bg-primary)", color: "var(--text-secondary)", cursor: "pointer", fontFamily: "var(--font-family)" }, children: "Cancel" }),
      agents.length > 0 && /* @__PURE__ */ jsx("button", { onClick: handleAdd, disabled: !selectedAgent, style: { padding: "6px 14px", fontSize: 12, fontWeight: 500, borderRadius: 4, border: "1px solid var(--border-accent)", background: "var(--bg-accent)", color: "var(--text-accent)", cursor: selectedAgent ? "pointer" : "not-allowed", opacity: selectedAgent ? 1 : 0.5, fontFamily: "var(--font-family)" }, children: "Add Member" })
    ] })
  ] });
}
...
function PlanView({ group }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { marginBottom: 20 }, children: [
    /* @__PURE__ */ jsxs("h3", { style: { margin: "0 0 8px 0", fontSize: 13, fontWeight: 600, color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.05em", fontFamily: "var(--font-family)" }, children: [
      "Plan (",
      completedCount,
      "/",
    ...
    /* @__PURE__ */ jsx("div", { style: { fontSize: 13, color: "var(--text-primary)", fontFamily: "var(--font-family)", background: "var(--bg-surface)", padding: "10px 14px", borderRadius: 6, lineHeight: 1.5, marginBottom: 12 }, children: plan.summary.length > 300 ? `${plan.summary.slice(0, 300)}...` : plan.summary }),
    plan.deliverables.map((d) => {
      const assignee = group.members.find((m) => m.id === d.assigneeId);
      return /* @__PURE__ */ jsxs("div", { style: { padding: "10px 14px", marginBottom: 4, borderRadius: 6, border: "1px solid var(--border-primary)", background: d.status === "complete" ? "var(--bg-success)" : "var(--bg-primary)" }, children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
            /* @__PURE__ */ jsx("span", { style: { fontSize: 11, fontWeight: 600, color: "var(--text-muted)", fontFamily: "var(--font-mono)" }, children: d.id.toUpperCase() }),
            /* @__PURE__ */ jsx("span", { style: { fontSize: 13, fontWeight: 500, color: "var(--text-primary)", fontFamily: "var(--font-family)" }, children: d.title })
          ] }),
          /* @__PURE__ */ jsx("span", { style: { fontSize: 11, fontWeight: 500, color: deliverableStatusColor(d.status), textTransform: "uppercase", letterSpacing: "0.03em" }, children: deliverableStatusLabel(d.status) })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: { fontSize: 11, color: "var(--text-tertiary)", marginTop: 4, fontFamily: "var(--font-family)" }, children: [
...
function GroupList({ api, groups, onSelect, onCreate, onDelete }) {
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100%" }, children: [
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px 12px", borderBottom: "1px solid var(--border-primary)" }, children: [
      /* @__PURE__ */ jsx("h2", { style: { margin: 0, fontSize: 16, fontWeight: 600, color: "var(--text-primary)", fontFamily: "var(--font-family)" }, children: "Buddy Groups" }),
    ...
    /* @__PURE__ */ jsxs("div", { style: { flex: 1, overflow: "auto", padding: "8px 12px" }, children: [
      ...
      groups.map((group) => /* @__PURE__ */ jsxs("div", { onClick: () => onSelect(group), style: { padding: "14px 16px", marginBottom: 6, borderRadius: 8, border: "1px solid var(--border-primary)", cursor: "pointer", background: "var(--bg-primary)" }, children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
          ...
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
            /* @__PURE__ */ jsx("span", { style: { fontSize: 11, fontWeight: 500, color: statusColor(group.status), textTransform: "uppercase", letterSpacing: "0.05em" }, children: STATUS_LABELS[group.status] ?? group.status }),
            /* @__PURE__ */ jsx("button", { onClick: (e) => {
              e.stopPropagation();
              onDelete(group.id);
            }, title: "Delete group", style: { background: "none", border: "none", color: "var(--text-muted)", cursor: "pointer", fontSize: 14, padding: "2px 4px", lineHeight: 1, borderRadius: 4 }, children: "x" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: { fontSize: 12, color: "var(--text-tertiary)", marginTop: 4, fontFamily: "var(--font-family)" }, children: [
...
function GroupDetail({ api, group, store, plannerRef, onBack, onGroupUpdated }) {
  ...
  const handleSetLeader = useCallback(async (memberId) => {
    const updated = await store.setLeader(group.id, memberId);
    onGroupUpdated(updated);
  }, [group.id, store, onGroupUpdated]);
  const handleAddMember = useCallback(async (agent, project, context) => {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100%" }, children: [
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "16px 20px 12px", borderBottom: "1px solid var(--border-primary)" }, children: [
      ...
      editing ? /* @__PURE__ */ jsx("input", { value: nameInput, onChange: (e) => setNameInput(e.target.value), onBlur: handleRename, onKeyDown: (e) => {
        if (e.key === "Enter") handleRename();
        if (e.key === "Escape") {
          setNameInput(group.name);
          setEditing(false);
        }
      }, autoFocus: true, style: { flex: 1, fontSize: 16, fontWeight: 600, color: "var(--text-primary)", fontFamily: "var(--font-mono)", background: "var(--bg-surface)", border: "1px solid var(--border-accent)", borderRadius: 4, padding: "2px 8px", outline: "none" } }) : /* @__PURE__ */ jsx("h2", { onClick: () => {
        setNameInput(group.name);
        setEditing(true);
...
function MainPanel({ api }) {
  ...
  useEffect(() => {
    const handleEvent = async (groupId, event) => {
      ...
      if (event.type === "status-updated") {
        ...
        if (member) member.status = event.status.status;
  ...
  if (!loaded || !store) {
    return /* @__PURE__ */ jsx("div", { style: { ...themeStyle, height: "100%", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsx("span", { style: { color: "var(--text-tertiary)", fontSize: 14, fontFamily: "var(--font-family)" }, children: "Loading..." }) });
  }
