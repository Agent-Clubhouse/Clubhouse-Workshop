...
var color = {
  ...
  text: "var(--text-primary, #222222)",
  textSecondary: "var(--text-secondary, #555555)",
  ...
  textWarning: "var(--text-warning, #cc9900)",
...
function MainPanel({ api }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { ...themeStyle, display: "flex", flexDirection: "column", height: "100%", background: color.bg, fontFamily: font.family, overflow: "auto" }, children: [
