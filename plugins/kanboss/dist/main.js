...
var { useState: useState5, useMemo } = React6;
function MiniBar({ items, colorFn }) {
  const max = Math.max(...items.map((i) => i.count), 1);
  return /* @__PURE__ */ jsx6("div", { style: { display: "flex", flexDirection: "column", gap: 3 }, children: items.map((item, i) => /* @__PURE__ */ jsxs6("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
    /* @__PURE__ */ jsx6("span", { style: { fontSize: 10, color: color.textTertiary, width: 70, textAlign: "right", flexShrink: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: item.label }),
    /* @__PURE__ */ jsx6("div", { style: { flex: 1, height: 10, background: color.bgTertiary, borderRadius: 4, overflow: "hidden" }, children: item.count > 0 && /* @__PURE__ */ jsx6("div", { style: {
    ...
    /* @__PURE__ */ jsx6("span", { style: { fontSize: 10, color: color.textSecondary, width: 20, flexShrink: 0 }, children: item.count })
  ] }, i)) });
}
function StatPill({ label, value, color: color2 }) {
  return /* @__PURE__ */ jsxs6("div", { style: {
    ...
    /* @__PURE__ */ jsx6("span", { style: { fontSize: 16, fontWeight: 600, color: color2 || color.text }, children: value }),
    /* @__PURE__ */ jsx6("span", { style: { fontSize: 9, color: color.textTertiary, marginTop: 2 }, children: label })
  ] });
}
var STATE_COLORS = [
...
function BoardStats({ cards, board }) {
  ...
  return /* @__PURE__ */ jsxs6("div", { style: { borderBottom: `1px solid ${color.border}`, fontFamily: font.family }, children: [
    /* @__PURE__ */ jsxs6(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx6("span", { style: { fontSize: 10, color: color.textTertiary, transform: expanded ? "rotate(90deg)" : "none", transition: "transform 0.15s" }, children: "\u25B6" }),
          /* @__PURE__ */ jsx6("span", { style: { fontSize: 11, color: color.textSecondary, fontWeight: 500 }, children: "Stats" }),
          !expanded && /* @__PURE__ */ jsxs6("span", { style: { fontSize: 10, color: color.textTertiary }, children: [
            stats.totalCards,
            " cards",
            stats.stuckCount > 0 && /* @__PURE__ */ jsxs6("span", { style: { color: color.textError }, children: [
              " \xB7 ",
              stats.stuckCount,
              " stuck"
            ] }),
            !isNaN(stats.automationSuccessRate) && /* @__PURE__ */ jsxs6("span", { children: [
              " \xB7 ",
              successRateStr,
              " auto"
            ] })
    ...
    expanded && /* @__PURE__ */ jsxs6("div", { style: { padding: "8px 16px 12px", display: "flex", flexDirection: "column", gap: 12 }, children: [
      /* @__PURE__ */ jsxs6("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" }, children: [
        /* @__PURE__ */ jsx6(StatPill, { label: "Total", value: String(stats.totalCards) }),
        /* @__PURE__ */ jsx6(StatPill, { label: "Stuck", value: String(stats.stuckCount), color: stuckColor }),
        /* @__PURE__ */ jsx6(StatPill, { label: "Auto Rate", value: successRateStr, color: successRateColor }),
        !isNaN(stats.automationSuccessRate) && /* @__PURE__ */ jsx6(
          StatPill,
          {
            label: "Auto Runs",
      ...
      /* @__PURE__ */ jsxs6("div", { children: [
        /* @__PURE__ */ jsx6("div", { style: { fontSize: 10, fontWeight: 500, color: color.textSecondary, marginBottom: 4 }, children: "Cards by State" }),
        /* @__PURE__ */ jsx6(
          MiniBar,
          {
      ...
      /* @__PURE__ */ jsxs6("div", { children: [
        /* @__PURE__ */ jsx6("div", { style: { fontSize: 10, fontWeight: 500, color: color.textSecondary, marginBottom: 4 }, children: "Priority Breakdown" }),
        /* @__PURE__ */ jsx6(
          MiniBar,
          {
...
var { useEffect: useEffect4, useState: useState6, useCallback: useCallback6, useRef: useRef3 } = React7;
...
function BoardView({ api }) {
  ...
  return /* @__PURE__ */ jsxs7("div", { style: { display: "flex", flexDirection: "column", height: "100%", background: color.bg, fontFamily: font.family }, children: [
    ...
    /* @__PURE__ */ jsx7(BoardStats, { cards, board }),
